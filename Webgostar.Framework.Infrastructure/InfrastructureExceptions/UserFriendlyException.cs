...
namespace Webgostar.Framework.Infrastructure.InfrastructureExceptions
{
    public class UserFriendlyException : Exception
    {
        ...
        public UserFriendlyException(ErrorCode errorCode, string userFriendlyMessage,
        ...
        public UserFriendlyException(ErrorCode errorCode, string message, string userFriendlyMessage,
